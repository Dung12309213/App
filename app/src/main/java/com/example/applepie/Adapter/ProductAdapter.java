...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        db.collection("Product")
                ...
                .addOnFailureListener(e -> {
                    // Xử lý lỗi khi không lấy được biến thể
                    // Log.e("ProductAdapter", "Lỗi khi lấy biến thể V1 cho sản phẩm " + documentId, e);
                    holder.tvSecondPrice.setVisibility(View.GONE);
                    holder.tvProductDiscountPercent.setVisibility(View.GONE);
                });
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            tvSecondPrice = itemView.findViewById(R.id.tvSecondPrice);
